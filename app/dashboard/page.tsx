            ...
            <div className="p-5 space-y-3 flex-1">
              {atendimentos.length === 0 ? (
                ...
                atendimentos.map((paciente) => (
                  <div key={paciente.id} className="flex items-center justify-between p-4 rounded-xl bg-slate-950/50 border border-slate-800/50 hover:border-emerald-500/30 transition-all shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="text-xs text-red-400/80 hover:text-red-400 hover:bg-red-500/10 px-2.5 py-1.5 rounded-lg transition-colors border border-transparent hover:border-red-500/20"
            ...
            <div className="p-5 flex flex-col gap-3">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400">Marcar atendimento no sistema</p>
                </div>
              </button>
              ...
              <form onSubmit={handleAgendarConsulta} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-800 bg-slate-950 p-3 text-sm text-white focus:border-emerald-500 focus:outline-none"
                  />
                </div>

                <div>
                  <label className="block text-xs text-slate-400 mb-1">Tipo de Consulta</label>
                  <select
                    value={novoTipo}
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="w-1/2 py-3 rounded-xl border border-slate-800 text-xs font-bold text-slate-300 hover:bg-slate-800"
                  >
                    Cancelar
                  </button>
                  <button
